...
from finance.public_views import public_finance, public_finance_attachment
...
urlpatterns = [
    ...
    path("finance/attachments/<str:attachment_id>/", public_finance_attachment, name="public-finance-attachment"),
