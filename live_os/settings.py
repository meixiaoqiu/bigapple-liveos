...
BIG_APPLE_AUTHORIZATION_BACKEND = config_value("BIG_APPLE_AUTHORIZATION_BACKEND", "openfga").strip().lower()
OPENFGA_REAL_API_URL = config_value("OPENFGA_REAL_API_URL", "http://127.0.0.1:20103").rstrip("/")
OPENFGA_REAL_STORE_NAME = config_value("OPENFGA_REAL_STORE_NAME", "big-apple-realworld")
OPENFGA_REAL_STORE_ID = config_value("OPENFGA_REAL_STORE_ID", "")
OPENFGA_REAL_AUTHORIZATION_MODEL_ID = config_value("OPENFGA_REAL_AUTHORIZATION_MODEL_ID", "")
OPENFGA_REAL_PLATFORM_OBJECT = config_value("OPENFGA_REAL_PLATFORM_OBJECT", "platform:realworld")
OPENFGA_SIM_API_URL = config_value("OPENFGA_SIM_API_URL", "http://127.0.0.1:20106").rstrip("/")
OPENFGA_SIM_STORE_NAME = config_value("OPENFGA_SIM_STORE_NAME", "big-apple-simulation0001")
OPENFGA_SIM_STORE_ID = config_value("OPENFGA_SIM_STORE_ID", "")
OPENFGA_SIM_AUTHORIZATION_MODEL_ID = config_value("OPENFGA_SIM_AUTHORIZATION_MODEL_ID", "")
OPENFGA_SIM_PLATFORM_OBJECT = config_value("OPENFGA_SIM_PLATFORM_OBJECT", "platform:simulation0001")
