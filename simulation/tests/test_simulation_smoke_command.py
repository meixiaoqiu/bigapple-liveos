...
class SimulationSmokeCommandTests(TestCase):
    ...
    def test_seed_world_zero_start_without_bootstrap_administrator_creates_virtual_founder_baseline(self) -> None:
        output = StringIO()
    ...
    def test_seed_world_zero_start_uses_bootstrap_administrator_as_only_initial_member(self) -> None:
        output = StringIO()
        env = {
            "BIG_APPLE_SIMULATION_BOOTSTRAP_ADMINISTRATOR_ENABLED": "true",
            "BIG_APPLE_SIMULATION_BOOTSTRAP_ADMINISTRATOR_USERNAME": "solo-founder",
            "BIG_APPLE_SIMULATION_BOOTSTRAP_ADMINISTRATOR_PASSWORD": "test-password",
            "BIG_APPLE_SIMULATION_BOOTSTRAP_ADMINISTRATOR_MEMBER_NO": "solo-founder",
            "BIG_APPLE_SIMULATION_BOOTSTRAP_ADMINISTRATOR_DISPLAY_NAME": "Solo founder",
        }
