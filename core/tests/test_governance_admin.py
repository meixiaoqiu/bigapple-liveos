...
from core.models import SystemEvent, Member, Organization, Proposal, Role, RoleAssignment, RolePermission
...
class GrantGovernanceAdminCommandTests(TestCase):
    def test_grant_governance_admin_assigns_role_and_permission(self):
        ...
        member = create_member("member-governance-admin-target", role_name=ROLE_CONTRIBUTOR, user=user)
        output = StringIO()
    ...
    def test_grant_governance_admin_is_idempotent_for_active_assignment(self):
        ...
        member = create_member("member-repeat-admin", role_name=ROLE_CONTRIBUTOR, user=user)
        output = StringIO()
    ...
    def test_grant_governance_admin_reports_explicit_world_id(self):
        ...
        create_member("member-world-admin-target", role_name=ROLE_CONTRIBUTOR, user=user)
        output = StringIO()
