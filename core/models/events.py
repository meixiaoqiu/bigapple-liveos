...
class SystemEvent(models.Model):
    ...
    class EventType(models.TextChoices):
        ...
        ELECTORATE_RULE_PUBLISHED = "electorate_rule_published", "选民规则已发布"
        PROPOSAL_VOTING_STARTED = "proposal_voting_started", "提案表决已开始"
        PROPOSAL_BALLOT_CAST = "proposal_ballot_cast", "提案票据已提交"
        PROPOSAL_EXPIRED = "proposal_expired", "提案已过期"
        PROPOSAL_EXECUTION_FAILED = "proposal_execution_failed", "提案执行失败"
