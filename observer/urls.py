...
urlpatterns = [
    ...
    path(
        "resources/<str:resource_id>/offers/",
        page_views.observer_resource_offers,
        name="observer-resource-offers",
    ),
    path(
        "resources/<str:resource_id>/offers/new/",
        page_views.observer_resource_offer_new,
        name="observer-resource-offer-new",
    ),
    path(
        "resources/<str:resource_id>/offers/<str:quote_id>/",
        page_views.observer_resource_offer_detail,
        name="observer-resource-offer-detail",
    ),
    path(
        "resources/<str:resource_id>/offers/<str:quote_id>/challenges/new/",
